# Capability: multi-turn-chat

## Purpose

Stateful multi-turn conversation between the user and the AI assistant. Messages stream in via SSE chunks and finalize into immutable assistant messages; cancellation preserves already-committed history.
